...
**Approach:** Phân tách rạch ròi giữa "Quyền thao tác phần mềm" (bảo vệ bằng CEO Permission Portal) và "Quyền can thiệp hạ tầng/Database" (Bảo vệ bằng Server). Tuyệt đối không để User bình thường có quyền can thiệp thẳng vào DB (bỏ qua Audit Log).
